            ...
            <div class="row-top">
                <div class="col-3">
                    <label>First Name : </label><br><input type="text" name="first_name"
                        value="<?php echo Session::get('userData')['first_name'] ?>"><br><br>
                    <label>Last Name : </label><br><input type="text" name="last_name"
                        value="<?php echo Session::get('userData')['last_name'] ?>"><br><br>
                    <label>Mobile Number : </label><br><input type="text" name="contact_no"
                        value="<?php echo Session::get('userData')['contact_no'] ?>"><br><br>
                ...
                <div class="col-3">
                    ...
                    <label>Email : </label><br><input type="email" name="email"
                        value="<?php echo Session::get('userData')['email'] ?>"><br><br>

                    <label>Gender : </label><br><select name="gender"
                        value="<?php echo Session::get('userData')['gender'] ?>">
                        <option value="male"
                            <?php if(Session::get('userData')['gender']=='male') echo "selected=\"selected\"";?>>Male
                        </option>
                        <option value="female"
                    ...
                    <label>City</label><br><input type="text" name="city"
                        value="<?php if(isset(Session::get('addressData')['city'])){echo Session::get('addressData')['city'];} ?>"><br><br>
                        <?php } ?>
                    ...
                    <input type="text" name="address_id" value="<?php echo Session::get('addressData')['address_id']?>"
                        hidden>
                </div>
                <?php if(Session::get('userType')=='customer'){?>
                <div class="col-3">
                    <label>Address Line 1</label><br><input type="text" name="address_line_1"
                        value="<?php if(isset(Session::get('addressData')['address_line_1'])){echo Session::get('addressData')['address_line_1'];} ?>"><br><br>
                    <label>Address Line 2</label><br><input type="text" name="address_line_2"
                        value="<?php if(isset(Session::get('addressData')['address_line_1'])){echo Session::get('addressData')['address_line_1'];} ?>"><br><br>
                    <label>Address Line 3</label><br><input type="text" name="address_line_3"
                        value="<?php if(isset(Session::get('addressData')['address_line_1'])){echo Session::get('addressData')['address_line_1'];} ?>"><br><br>
                </div>
                <?php } ?>
