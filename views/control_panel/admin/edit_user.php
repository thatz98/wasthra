                      ...
                      <div class="helper-text">
                        <label>User Type</label><br><select name="user_type" <?php if($this->user[0]['user_type']=='owner') echo 'disabled';?>>
                            <option value="customer"
                                ...
                                Customer</option>
                            <option value="admin"
                                <?php if($this->user[0]['user_type']=='admin') echo "selected=\"selected\"";?>>Admin
                            </option>
                        ...
                        <label>User Status</label><br><select name="user_status"
                            ...
                            <option value="verified"
                                <?php if($this->user[0]['user_status']=='verified') echo "selected=\"selected\"";?>>
                                Verified</option>
                            <option value="blocked"
                                <?php if($this->user[0]['user_status']=='blocked') echo "selected=\"selected\"";?>>
                                Blocked</option>
                            <option value="retired"
                                <?php if($this->user[0]['user_status']=='retired') echo "selected=\"selected\"";?>>
                                Retired</option>
                        </select><br>
                    </div>
                    <div class="col-2">
                        ...
                        <label>Gender</label><br><select name="gender"
                            ...
                            <option value="female"
                                <?php if($this->user[0]['gender']=='female') echo "selected=\"selected\"";?>>Female
                            </option>
                        </select><br>

                        <input type="text" name="user_id" value="<?php echo $this->user[0]['user_id']?>" hidden>
                        <input type="text" name="prev_user_type" value="<?php echo $this->user[0]['user_type']?>"
                            hidden>
