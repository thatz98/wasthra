                        ...
                        <tr>
                            ...
                            <td class="order-details">
                                ...
                                <div class="item-input">
                                    <label>Color:</label><span class="color-dot" style="background-color: <?php echo $item['item_color'] . ';';
                                                                                                            if (strcasecmp($item['item_color'], '#fff') == 0 || strcasecmp($item['item_color'], '#ffffff') == 0) echo 'border: 0.5px solid #000;'; ?>"></span>
