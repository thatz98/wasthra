            ...
            <form action="<?php echo URL; ?>products/editSave/<?php echo $this->product[0]['product_id'] ?>" enctype="multipart/form-data" id="editFrom" method="post">
                        ...
                        <div class="row-top">
                            ...
                            <div class="helper-text">
                                ...
                                <input type="text" id="product_id" name="product_id" value="<?php echo $this->product[0]['product_id'] ?>" 
                            ...
                            <div class="helper-text">
                                ...
                                <input type="text" id="product_name" name="product_name" value="<?php echo $this->product[0]['product_name'] ?>"
                            ...
                            <div class="helper-text">                            
                                ...
                                <?php if($this->product[0]['name']==$category['name']){echo "selected=\"selected\""; $this->selectedCat=$category['name'];}?>>
                        ...
                        <label>New</label><br><select id="is_new" name="is_new">
                            ...
                            <?php foreach ($this->price_category as $price): ?><option value="<?php echo $price['price_category_name']; ?>" <?php if($this->product[0]['price_category_name']==$price['price_category_name']) echo "selected=\"selected\"";?>><?php echo $price['price_category_name']; ?></option> <?php endforeach;?>
                            </select>
                            ...
                            data-helper="Description" onfocusout="validateDescription()"><?php echo $this->product[0]['product_description'] ?></textarea>
                            <span class="popuptext"></span>
                            <br>
                            </div>
