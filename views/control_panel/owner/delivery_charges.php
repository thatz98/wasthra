...
<link rel="stylesheet" type="text/css" href="<?php echo URL?>public/css/filter_dropdown.css">
    ...
    <div class="row-right">
        ...
        <div class="table-search">
            <input type="text" id="keyword-input" onkeyup="filterByKeyword('dcharges-table',7)"
    ...
    <table id="dcharges-table">
      <thead>
         <tr>
            <th>City<i onclick="showFilters('dcharges-table',0,'dropdown-filter-1','checkbox-1','checkbox-all-1')"
                        ...
                        <div class="dropdown-filter-content">
                            ...
                            <div class="dropdown-filter-search table-search">
                                <input type="text" id="dropdown-keyword-input-1"
                                    onkeyup="filterByDropdownKeyword('dcharges-table',0,'dropdown-keyword-input-1')"
                                    placeholder="Filter by keyword..">
                            </div>
                            <div class="checkbox-container">
                                <input class="select-all" type="checkbox" id="checkbox-all-1"
                                    onchange="checkAll('dcharges-table','checkbox-all-1')" checked="true"><span>Select
                                    All</span>
                                <div id="checkbox-1">
                                </div>
            ...
            <th>Delivery Fee<i onclick="showFilters('dcharges-table',1,'dropdown-filter-2','checkbox-2','checkbox-all-2')"
                               class="fa fa-filter" aria-hidden="true" style="font-size: 13px; margin: 5px 0 0 5px;"></i>
                        ...
                        <div class="dropdown-filter-content">
                            ...
                            <div class="dropdown-filter-search table-search">
                                <input type="text" id="dropdown-keyword-input-2"
                                    onkeyup="filterByDropdownKeyword('dcharges-table',1,'dropdown-keyword-input-2')"
                                    placeholder="Filter by keyword..">
                            </div>
                            <div class="checkbox-container">
                                <input class="select-all" type="checkbox" id="checkbox-all-2"
                                    onchange="checkAll('dcharges-table','checkbox-all-2')" checked="true"><span>Select
                                    All</span>
                                <div id="checkbox-2">
                                </div>
...
<script type="text/javascript" src="/util/form/delivery_charges_form_validation.js"></script>
