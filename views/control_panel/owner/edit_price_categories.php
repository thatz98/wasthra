                        ...
                        <div class="row-top">   
                            <div class="col-3">
                                ...
                                <div class="helper-text">
                                    ...
                                    <input type="text" name="category_id" id="category_id" data-helper="Category ID" onfocusout="validateCategoryId()" 
                                     placeholder="PRCXXXX" value="<?php echo $this->getpricecat['price_category_id'] ?>">
                                    <span class="popuptext"></span>
                                </div><br><br><br>

                                <div class="helper-text">                            
                                    <label>Production Cost</label><br>
                                    <input type="text" name="production_cost" id="production_cost" data-helper="Cost" onfocusout="validateProductionCost()"
                                     placeholder="LKR" value="<?php echo $this->getpricecat['production_cost'] ?>">
                                    <span class="popuptext"></span>
                                </div><br>
                            </div>
                            ...
                            <div class="col-3">
                                <div class="helper-text">
                                    ...
                                    <input type="text" name="category_name" id="category_name" data-helper="Category Name" onfocusout="validateCategoryName()"
                                     value="<?php echo $this->getpricecat['price_category_name'] ?>">
                                    <span class="popuptext"></span>
                                </div><br><br><br>

                                <div class="helper-text">
                                    <label>Additional Market Price</label><br>
                                    <input type="text" name="market_price" id="market_price" data-helper="Market Price" onfocusout="validateMarketPrice()" 
                                     placeholder="LKR" value="<?php echo $this->getpricecat['add_market_price'] ?>">
                                    <span class="popuptext"></span>
                                </div><br>  
                            </div>                           
                        </div>
                           ...
                           <div class="center-content">
                                ...
                                <input type="text" name="discount" id="discount" data-helper="Discount" onfocusout="validateDiscount()" 
                                 value="<?php echo $this->getpricecat['discount'] ?>" style="text-align: center;">%
...
<script type="text/javascript" src="<?php echo URL ?>util/form/edit_price_category_form_validation.js"></script>
