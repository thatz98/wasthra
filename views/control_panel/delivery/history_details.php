                       ...
                       <img src="<?php echo URL.$item['image'];?>" width="50px" height="50px">
                        ...
                        <td class="order-details">
                            ...
                            <div class="item-input">
                                <label>Color:</label><span class="color-dot" style="background-color: <?php echo $item['item_color'].';'; if(strcasecmp($item['item_color'], '#fff') == 0 || strcasecmp($item['item_color'], '#ffffff') == 0) echo 'border: 0.5px solid #000;'; ?>"></span>
                ...
                <div class="box-container">
                    <div class="delivery-info">
                        ...
                        <div class="row">
                            ...
                            <div class="col-2" style="min-width: 0;">
                                    <label class="address">
                                    Actual Delivery Date: <?php echo $this->orderDetails['actual_delivery_date']; ?><br><br>
                                    Delivery Performed By: <?php echo Session::get('userData')['first_name'].' '.Session::get('userData')['last_name'];?><br>
                                </label>
                            </div>
                        </div>
                    </div>
