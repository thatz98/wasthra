<div id="addReview" class="overlay">
    ...
    <div class="popup">
        ...
        <div class="row">
            <form action="<?php echo URL; ?>shop/submitReview/<?php echo $this->product[0]['product_id']?>" id="addFrom"
                enctype="multipart/form-data" method="post">
                <div class="row">
                <p>You have selected "<?php  echo $this->product[0]['product_name']?>"</p>
            </div>
            ...
            <input type="text" name="product_id" value="<?php echo $this->product[0]['product_id']?>" hidden>
            <div class="row">
                <div class="col-2">
