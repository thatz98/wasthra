        ...
        success: function (data) {
          ...
          if(data.length>0){
            data.forEach(product => {
              ...
              list_item.innerHTML = `<a href=\"http://127.0.0.1/wasthra/shop/productDetails/${product.product_id}\"><img src=/wasthra/${product.image}><span class=\"search-link\">${product.product_name}<br>${product.name}</span></a>`;
